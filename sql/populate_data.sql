...
SELECT 'Assistidas inseridas:' AS info, COUNT(*) AS total FROM assistidas;
SELECT 'Drogas utilizadas registradas:' AS info, COUNT(*) AS total FROM drogas_utilizadas;
SELECT 'Internações registradas:' AS info, COUNT(*) AS total FROM internacoes;
SELECT 'Medicações utilizadas registradas:' AS info, COUNT(*) AS total FROM medicamentos_utilizados;