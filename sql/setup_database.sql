...
(
    ...
    tipo_doador ENUM
('PF', 'PJ') NOT NULL COMMENT 'Tipo de doador: PF = Pessoa Física, PJ = Pessoa Jurídica',
    nome_doador VARCHAR
(255) NOT NULL,
    documento VARCHAR
(14) NOT NULL COMMENT 'CPF (11 dígitos) ou CNPJ (14 dígitos) sem formatação',
    email VARCHAR
(255),
    telefone VARCHAR
(15) NOT NULL COMMENT 'Telefone sem formatação',
    valor DECIMAL
(10, 2) NOT NULL COMMENT 'Valor da doação em reais',
    data_doacao DATE NOT NULL COMMENT 'Data em que a doação foi realizada',
    observacoes TEXT,
    data_cadastro DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    data_atualizacao DATETIME ON
...
UPDATE CURRENT_TIMESTAMP
NOT NULL,
    CONSTRAINT pk_Medicamentos PRIMARY KEY
(id)
);
